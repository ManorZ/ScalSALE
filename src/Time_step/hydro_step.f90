        ...
        do k = 1, this%nzp
            do j = 1, this%nyp
                do i = 1, this%nxp
                    ...
                    !call Calculate_acceleration_1d(inversed_vertex_mass(i, j, k), dt_mid, -ps1, -ps2, -ps3, -ps4, -ps5, -ps6, -ps7, -ps8, x1, x2, x3, x4, x5, x6, y1, y2, y3, y4, y5, y6, acceleration_z(i, j, k))
